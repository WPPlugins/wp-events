...
/*
Plugin Name: Events
Plugin URI: https://ajdg.solutions/?pk_campaign=plugin-url
Author: Arnan de Gans
Author URI: http://www.arnan.me/?pk_campaign=author-url
...
function events_schedule() {
	...
	<div class="wrap">
				      	...
				      	<tr>
					        ...
					        <td width="25%">
								...
								<select name="events_emonth" tabindex="10">
									...
									<option value="03" <?php if($emonth == "03") { echo 'selected'; } ?>><?php _e('March'); ?></option>
									<option value="04" <?php if($emonth == "04") { echo 'selected'; } ?>><?php _e('April'); ?></option>
									<option value="05" <?php if($emonth == "05") { echo 'selected'; } ?>><?php _e('May'); ?></option>
									<option value="06" <?php if($emonth == "06") { echo 'selected'; } ?>><?php _e('June'); ?></option>
									<option value="07" <?php if($emonth == "07") { echo 'selected'; } ?>><?php _e('July'); ?></option>
									<option value="08" <?php if($emonth == "08") { echo 'selected'; } ?>><?php _e('August'); ?></option>
									<option value="09" <?php if($emonth == "09") { echo 'selected'; } ?>><?php _e('September'); ?></option>
									<option value="10" <?php if($emonth == "10") { echo 'selected'; } ?>><?php _e('October'); ?></option>
		...
		<?php } else { ?>
		    <table class="form-table">
				<tr valign="top">
					<td bgcolor="#DDD"><strong><?php _e('This is not an event created by you. Therefor you cannot edit it.', 'wpevents'); ?></td>
				</tr>
			</table>
		<?php } ?>
	</div>
...
function events_options() {
	global $events_dbversion;
	
	$events_version = get_option('events_version');
	$events_config = get_option('events_config');
	$events_template = get_option('events_template');
	$events_language = get_option('events_language');
	  	...
	  	<form method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>&amp;updated=true">
	    	...
	    	<table class="form-table">
				...
				<tr valign="top">
		      	...
		      	<tr valign="top">
			        ...
			        <td colspan="3"><select name="events_sideshow">
				        ...
				        <option value="7" <?php if($events_config['sideshow'] == "7") { echo 'selected'; } ?>><?php _e('Upcoming and/or Archived events', 'wpevents'); ?></option>
					</select></td>
		      	</tr>
		      	<tr valign="top">
		      	...
		      	<tr valign="top">
			        ...
			        <td colspan="3"><select name="events_hideendsidebar">
				        <option value="never" <?php if($events_config['hideendsidebar'] == "never") { echo 'selected'; } ?>><?php _e('Never show the ending date/time (Default)', 'wpevents'); ?> </option>
				        <option value="hide" <?php if($events_config['hideendsidebar'] == "hide") { echo 'selected'; } ?>><?php _e('Hide the ending date if it\'s the same as the starting date', 'wpevents'); ?> </option>
				        <option value="show" <?php if($events_config['hideendsidebar'] == "show") { echo 'selected'; } ?>><?php _e('Show the ending date even if it\'s the same as the starting date', 'wpevents'); ?> </option>
					</select></td>
		      	</tr>
		      	<tr valign="top">
				...
				<tr valign="top">
		      	...
		      	<tr valign="top">
			        <th scope="row"><?php _e('Add Events', 'wpevents'); ?></th>
			        <td colspan="3"><select name="events_addlevel">
				        <option value="manage_options" <?php if($events_config['addlevel'] == "manage_options") { echo 'selected'; } ?>><?php _e('Administrator', 'wpevents'); ?></option>
				        <option value="edit_pages" <?php if($events_config['addlevel'] == "edit_pages") { echo 'selected'; } ?>><?php _e('Editor'); ?> (<?php _e('default', 'wpevents'); ?>)</option>
				        <option value="publish_posts" <?php if($events_config['addlevel'] == "publish_posts") { echo 'selected'; } ?>><?php _e('Author', 'wpevents'); ?></option>
				        <option value="edit_posts" <?php if($events_config['addlevel'] == "edit_posts") { echo 'selected'; } ?>><?php _e('Contributor', 'wpevents'); ?></option>
				        <option value="read" <?php if($events_config['addlevel'] == "read") { echo 'selected'; } ?>><?php _e('Subscriber', 'wpevents'); ?></option>
					</select> <em><?php _e("Can add events and edit events they created.", 'wpevents'); ?></em></td>
		      	</tr>
		      	<tr valign="top">
			        <th scope="row"><?php _e('Edit events', 'wpevents'); ?></th>
					...
					</select> <em><?php _e("Can add/edit/review anyone's events.", 'wpevents'); ?></em></td>
		      	</tr>
		      	<tr valign="top">
					...
					</select> <em><?php _e("Can add/edit/review/delete anyone's events.", 'wpevents'); ?></em></td>
		      	</tr>
		      	<tr valign="top">
